...
#ifndef WHOLEBODY_IK_MODULE_HPP_
#define WHOLEBODY_IK_MODULE_HPP_
...
class wholebody_ik_module : public control_module<wholebody_ik_thread> {
public:
     ...
     * 
     */
    wholebody_ik_module(    int argc, 
                               char* argv[],
                               std::string module_prefix, 
                               int module_period, 
                               yarp::os::ResourceFinder rf ) : control_module<wholebody_ik_thread>(  argc, 
                                                                                                        argv, 
                                                                                                        module_prefix, 
                                                                                                        module_period,
                                                                                                        rf )
...
#endif //WHOLEBODY_IK_MODULE_HPP_
