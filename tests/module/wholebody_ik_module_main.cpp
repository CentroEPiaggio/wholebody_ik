...
#include "wholebody_ik_module.hpp"
...
int main(int argc, char* argv[])
{
    ...
    // create my module
    wholebody_ik_module wholebody_ik_mod = wholebody_ik_module( argc, argv, "wholebody_ik", MODULE_PERIOD, rf );
    
    // run the module
    wholebody_ik_mod.start();
    wholebody_ik_mod.runModule( rf );
